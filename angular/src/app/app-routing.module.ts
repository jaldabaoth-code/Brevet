...
const routes: Routes = [
    ...
    // This is the component with the <router-outlet> in the app template
    { path: 'user/profile', component: ProfilesComponent,canActivate: [IsLoggedInGuard],
        children: [
            {
                // Child route path
                path: 'edit',
                // Child route component that the router renders
                component: EditProfileComponent,canActivate: [IsLoggedInGuard]
            },
            {
                path: 'domains',
