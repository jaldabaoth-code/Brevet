...
export class EditProfileComponent implements OnInit {
    ...
    constructor(private tokenStorage: TokenStorageService, private userService: UserService, private router: Router, private route: ActivatedRoute, private formBuilder: FormBuilder) {
    ...
    onFormSubmit() {
        if (this.editProfileForm.valid) {
            this.userService.updateUser(this.editProfileForm.value).subscribe((userProfile) => {
                Swal.fire({
                    title: 'Félicitations!',
