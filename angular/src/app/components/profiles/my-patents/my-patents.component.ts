...
export class MyPatentsComponent implements OnInit {
    ...
    getDetailsByPatentCode(index: number) {
        ...
        if (this.patentsDetails.length == 0 || this.patentsDetails[index] == undefined) {
            ...
            // Collecting the patent information through OPS API, adding it to the variable patentsDetails, with the same index from the publication code, stocked in favoritePatent array
